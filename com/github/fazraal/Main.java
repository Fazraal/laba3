...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Learner st = new Student("Nicolaev", "Nicolay", "Nicolaevich", group1, "13.06.2016");
        ObjectOutputStream out1 = null;
        try {
            File file = new File("student2.bin");
       ...
       /* Scanner scanner = new Scanner(System.in);
        ...
        students2 = ControllerClass.getLearnerOnName(students1, name, 1);
            ...
            switch (index) {
                ...
                /*case (6): {
                    try {
                        ...
                        ControllerClass.loadInformationFromOtherFile(, students1);
